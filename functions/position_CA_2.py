...
## ------------------------------------------------------------------------------------------------------
def position_CA_2(dirname, PDBchain, case, CAim1, Cim1, N, omega, i, pbt, AA, RR):
   v1 = N     - Cim1 
   v2 = CAim1 - Cim1
   ...
   # ***************************************************************
      ...
      abar  = Ed1*EcosTh3
      dbar0 = Ed1*EsinTh3*np.cos(omega)
      dbar1 = Ed1*EsinTh3*np.sin(omega)
   # ***************************************************************
   #else:
   ...
   # ***************************************************************
      ...
      abar  = Ed1*np.cos(th3)
      dbar0 = Ed1*np.sin(th3)*EcosOmega
      dbar1 = Ed1*np.sin(th3)*EsinOmega
   # ***************************************************************
   elif((case[0] == '1') & (case[1] == '1') & (case[2] == '0')):
      abar  = d1*EcosTh3
      dbar0 = d1*EsinTh3*EcosOmega
      dbar1 = d1*EsinTh3*EsinOmega
   # ***************************************************************
   elif((case[0] == '1') & (case[1] == '1') & (case[2] == '1')):
      abar  = Ed1*EcosTh3
      dbar0 = Ed1*EsinTh3*EcosOmega
      dbar1 = Ed1*EsinTh3*EsinOmega
   # ***************************************************************
   else:
      print('ERROR in CA{:3.0f}\n'.format(i+1))
   # ***************************************************************'''
