...
## ------------------------------------------------------------------------------------------------------
def position_O(dirname, PDBchain, case, CA, C, Nip1, sigma, i, pbt, AA, RR):
   v1 = Nip1 - C 
   v2 = CA   - C
   ...
   Ed4cosTh4         = const[8]
   Ed4sinTh4         = const[9]
   Ed4cosSigma       = const[12]
   Ed4sinSigma       = const[13]
   EsinTh4cosSigma   = const[16]
   EsinTh4sinSigma   = const[17]
   Ed4sinTh4cosSigma = const[20]
   Ed4sinTh4sinSigma = const[21]
   # ***************************************************************
   ...
   # ***************************************************************
      ...
      abar  = Ed4cosTh4
      dbarC = Ed4sinTh4*np.cos(sigma)
      dbarS = Ed4sinTh4*np.sin(sigma)
   ...
   # ***************************************************************
      ...
      abar  = Ed4*np.cos(th4)
      dbarC = Ed4cosSigma*np.sin(th4)
      dbarS = Ed4sinSigma*np.sin(th4)
   # ***************************************************************
   elif((case[0] == '1') & (case[1] == '1') & (case[2] == '0')):
      abar  = d4*EcosTh4
      dbarC = d4*EsinTh4cosSigma
      dbarS = d4*EsinTh4sinSigma
   # ***************************************************************
   elif((case[0] == '1') & (case[1] == '1') & (case[2] == '1')):
      abar  = Ed4cosTh4
      dbarC = Ed4sinTh4cosSigma
      dbarS = Ed4sinTh4sinSigma
   # ***************************************************************
   else:
